...
<html>
    ...
    <body>
        ...
        <nav>
            ...
            <div>
                <a href="pagina3.html" target="conteudo">Listagem de produtos</a>
            </div>
            <div>
                <a href="pagina4.html" target="conteudo">Excluir produtos</a>
            </div>
            <div>
                <a href="pagina5.html" target="conteudo">Alterar produtos</a>
            </div>
        </nav>
        <main>
